package SeedViewer::WebPage::MetagenomeToolDescription;

# $Id: MetagenomeToolDescription.pm,v 1.5 2008-09-05 14:57:43 jared Exp $
...
sub output {
  ...
  # Fragment Profile
  $html .= "<h3><a name='seq_profile'/><em>Metagenome » <a href='?page=MetagenomeProfile&metagenome=$id'>Sequence Profile</a></em></h3>";
  ...
  $html .= "<h3><a name='blast'/><em>Metagenome » <a href='?page=MetagenomeBlastRun&metagenome=$id'>BLAST</a></em></h3>";
  ...
  # Heat map
  $html .= "<h3><a name='heat_map'/><em>Compare Metagenomes » <a href='?page=MetagenomeComparison&metagenome=$id'>Heat Map</a></em></h3>";
  ...
  # Recruitment plot
  $html .= "<h3><a name='recruit_plot'/><em>Compare Metagenomes » <a href='?page=MetagenomeRecruitmentPlot&metagenome=$id'>Recruitment Plot</a></em></h3>";
  ...
  # KEGG map
  $html .= "<h3><a name='kegg_map'/><em>Compare Metagenomes » <a href='?page=Kegg&organism=$id'>KEGG Map</a></em></h3>";
